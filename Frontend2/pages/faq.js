...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: `.docx (Microsoft Word) est accepté pour l'import de modèles. Le téléchargement du document finalisé se fait également au format .docx, que vous pouvez ensuite ouvrir, modifier ou convertir en PDF avec Word ou LibreOffice.`,
  },
  {
  ...
  },
  {
    ...
    a: `Rendez-vous dans l'espace Admin via http://localhost:4000/admin. Donnez un nom au modèle, importez votre fichier .docx, puis nommez chaque champ détecté. Cliquez sur "Publier le modèle" : il sera immédiatement disponible pour tous les utilisateurs dans la liste des documents.`,
  },
  {
